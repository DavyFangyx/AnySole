#!/usr/bin/env python3
"""Canonical R_Test10 / B3 display entry point."""
...
def main(argv=None) -> int:
    ...
    registry, spec, out_root = load_context(args.experiment, "rho_grid_analysis")
    for model_id in model_ids_for(spec, args.model):
        ...
        return rho_grid_main([
            "--metrics", str(metrics), "--out-dir", str(out),
        ])
    return 0
