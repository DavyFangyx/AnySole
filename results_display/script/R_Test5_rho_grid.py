#!/usr/bin/env python3
"""Canonical R_Test5 / A0 display entry point."""
...
def main(argv=None) -> int:
    ...
    registry, spec, out_root = load_context(args.experiment, "singlemodal_analysis")
    for main_id in model_ids_for(spec, args.model):
        # Specialists are derived from the main model (main + --config-probs
        # change), never listed in the conf.
