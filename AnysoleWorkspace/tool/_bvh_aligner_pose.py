...
Copy for AnysoleWorkspace/tool/contact_labels.py (data-side contact label
generation).  The display-layer original lives in
results_display/script/bvh_aligner_pose.py until the P1-4 consolidation.
"""
