...
| V3-2 | pose_head 九部位最小移植（`--pose-parts 9`） | 代码完成；前两次训练同型爆炸（xd6kcdk2 ep386、1s0yeuwn ep531），**第三次（2026-09-21，grad-clip+warmup+NaN 守卫）740ep 全程无爆炸**；ckpt_best@310 VT2M 67.4（链内最优）、contact_f1 VT 0.76；晚期仍有噪声漂移（310→740 升至 72.8），T-only 弱点留给 V3-3 σ 门控 |
