"""Person-centric 256x192 crop used by the HRNet extractor.

Geometry is copied from MotionPRO lib/util/gen_image_feature.py.
Do not change it to a square 256x256 crop.
"""
...
from anysole.types import IMG_NORM_MEAN, IMG_NORM_STD
