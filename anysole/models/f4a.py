"""F4a entry: foot_conv tactile encoder on the V2 regression structure.

Independent model (2026-09-24 restructure): the structure is fixed here;
every training run of F4a — at any --tw/--stride/… — starts from random
...
def build(config: dict, part_joints=None):
    """Construct the F4a network from the effective train config."""
