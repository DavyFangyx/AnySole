"""V3_4b entry: f2 representation + foot_conv + 9-part soft A.

Independent model (2026-09-24 restructure): the structure is fixed here;
every training run of V3_4b — at any --tw/--stride/… — starts from random
...
def build(config: dict, part_joints=None):
    """Construct the V3_4b network from the effective train config."""
