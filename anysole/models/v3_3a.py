"""V3_3A entry: foot_conv + 9-part + learned soft assignment matrix A.

Independent model (2026-09-24 restructure): the structure is fixed here;
every training run of V3_3A — at any --tw/--stride/… — starts from random
...
def build(config: dict, part_joints=None):
    """Construct the V3_3A network from the effective train config."""
