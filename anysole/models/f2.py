"""F2 entry: f2 representation (tilt/yaw split + 4-dim heading-frame traj).

Independent model (2026-09-24 restructure): the structure is fixed here;
every training run of F2 — at any --tw/--stride/… — starts from random
...
def build(config: dict, part_joints=None):
    """Construct the F2 network from the effective train config."""
