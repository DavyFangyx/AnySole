"""V3_4a entry: f2 representation + foot_conv + 9-part pose head.

Independent model (2026-09-24 restructure): the structure is fixed here;
every training run of V3_4a — at any --tw/--stride/… — starts from random
...
def build(config: dict, part_joints=None):
    """Construct the V3_4a network from the effective train config."""
